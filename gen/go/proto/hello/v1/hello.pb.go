...
const file_proto_hello_v1_hello_proto_rawDesc = "" +
	"\n" +
	"\x1aproto/hello/v1/hello.proto\x12\x05hello\"\"\n" +
	...
	"\aGreeter\x124\n" +
	"\bSayHello\x12\x13.hello.HelloRequest\x1a\x11.hello.HelloReply\"\x00B'Z%github.com/fastscripts/grpctest;hellob\x06proto3"
